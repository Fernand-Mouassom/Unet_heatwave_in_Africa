...
def unet_regressor(input_shape=(321, 321, 9), n_filters=32, dropout_rate=0.3, l2_strength=1e-4, lr=1e-3, loss_fn=None):
    ...
    model.compile(
        ...
        loss=loss_fn if loss_fn is not None else 'binary_crossentropy',
        metrics=['Recall']
    )
    return model
